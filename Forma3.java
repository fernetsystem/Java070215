...
public class Forma3 extends JPanel implements ActionListener {
  ...
  public Forma3() {
    ...
    Icon icono_2 = new ImageIcon(getClass().getResource("icono16.png"));
	...
	public void usar1(){
    	...
    	b.add(btn1);	b.add(btn2);	b.add(btn3);
   		...
   		btn2.setBounds(130,100,140,35);
   		btn3.setBounds(300,200,130,40);
   		btn1.setText("Examinar");	btn1.setBackground(new Color(49,74,82));		btn1.setForeground(Color.WHITE);
   		btn2.setText("Ver archivo");	btn2.setBackground(new Color(123,160,173));		btn2.setForeground(Color.WHITE); 
